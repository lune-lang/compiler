...
/* package lune-0.1.0.0 */
#ifndef VERSION_lune
#define VERSION_lune "0.1.0.0"
#endif /* VERSION_lune */
#ifndef MIN_VERSION_lune
#define MIN_VERSION_lune(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lune */
...
#define CURRENT_COMPONENT_ID "lune-0.1.0.0-inplace-lune"
